...
class VerTodasUpcoming extends Component {
    ...
    componentDidMount () {
        fetch("https://api.themoviedb.org/3/movie/upcoming?api_key=e4c9de46fa2b077570ba8601a80bf4d6&page=1")
        .then(res => res.json())
    ...
    cargarMas() {
        ...
        fetch(`https://api.themoviedb.org/3/movie/upcoming?api_key=e4c9de46fa2b077570ba8601a80bf4d6&page=${siguientePag}`)
        .then(res => res.json())
        .then(data => {
